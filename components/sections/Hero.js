...
function Hero() {
  ...
  return (
    <section className="flex flex-col py-16 gap-7 relative items-center z-10 h-screen overflow-hidden">
      ...
      <div className="flex flex-col px-5 gap-6 z-10 ">
        <TypingText
          ...
          classes={"font-Koulen font-semibold text-5xl text-primaryLigther"}
        />
        <TypingText
          delay={0.3}
          title={
          ...
          classes={
            "font-Koulen font-thin text-lg text-secondryBase text-opacity-75"
          }
        />
      </div>
