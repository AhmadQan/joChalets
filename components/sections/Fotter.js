...
function Fotter() {
  return (
    <div className="w-full bg-secondry30 text-primary100 p-8 z-10">
        ...
        <div className="w-full flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-4 font-normal">
            <div className="flex gap-2 items-start justify-start">
              <div className="w-3 mt-2  aspect-square rounded-full bg-primary90" />
        ...
        <div className="flex flex-col gap-12 justify-between">
          <div className="flex flex-col gap-5 text-sm">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex gap-1">
                <EmailIcomBold fill={"#333"} className={"w-5 aspect-square"} />
          ...
          <div className="flex flex-col gap-5 text-sm">
            ...
            <div className="flex  gap-2">
              <FaceBookIconBold fill={"#333"} className={"w-8 aspect-square"} />
              <InstgramBoldIcon fill={"#333"} className={"w-8 aspect-square"} />
            </div>
          </div>
