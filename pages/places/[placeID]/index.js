...
import CalendarDotsIcon from "../../../client/assets/icons/CalendarDotsIcon";
        ...
        <div className="absolute w-full h-[74%] bottom-0 left-0 bluegradientoverlay flex flex-col gap-4 justify-end pb-[25%] px-6">
          <div className="w-full flex justify-between">
            ...
            <div
              ...
              className="  rounded-xl flex flex-col gap-2 justify-start items-start"
            >
              <CalendarDotsIcon
                fill={"#fff"}
                className={"w-20 relative z-20 aspect-square shadow-flat"}
              />

              <h3 className="text-lg font-bold text-white font-IBMPlexSans">
                Availablity
              </h3>
            </div>
          </div>
